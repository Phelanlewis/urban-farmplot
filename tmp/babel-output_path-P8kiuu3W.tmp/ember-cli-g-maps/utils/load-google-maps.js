define('ember-cli-g-maps/utils/load-google-maps', ['exports', 'ember'], function (exports, _ember) {
  'use strict';
  ...
  var getLazyLoadSrc = function getLazyLoadSrc() {
    ...
    if (typeof query === 'object') {
      ...
      meta = _ember['default'].$(query).get(0);
    }
  ...
  var lazyLoadGoogleMap = function lazyLoadGoogleMap(src) {
    ...
    return new RSVP.Promise(function (resolve, reject) {
      _ember['default'].$.getScript(src).success(function emberCliGMapsLazyLoadSuccess() {
