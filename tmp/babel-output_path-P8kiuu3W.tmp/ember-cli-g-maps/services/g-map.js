define('ember-cli-g-maps/services/g-map', ['exports', 'ember'], function (exports, _ember) {
  ...
  exports['default'] = _ember['default'].Service.extend({
    maps: (function () {
      ...
      return {
        ...
        refresh: function refresh(name) {
          ...
          if (!mapStore) {
            _ember['default'].Logger.warn('Attempted to refresh undefined GMap instance: ' + (name || '(no map name given)'));
          } else {
    ...
    autocompletes: _ember['default'].computed({
      get: function get() {
        var autocompletes = {};
        return {
    ...
    googleAPI: _ember['default'].computed({
      get: function get() {}
    })
  });
});